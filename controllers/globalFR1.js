    ...
    Case1Insert: async function (req, res) { 
        ...
        if(year < 1980){
            ...
            try {
                ...
                //perform insert
                sqlEntryFill = 'INSERT INTO node3 (title, year, genre, director, actor1, actor2) VALUES (?,?,?,?,?,?)';
                datalist = node3Connection.query(sqlEntryFill, [title, year, genre, director, actor1,actor2])
